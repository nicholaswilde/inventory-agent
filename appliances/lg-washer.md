...
- **Homebox Entity ID**: `e7b79905-9ba0-43e2-a8fd-d2964a8a911c`
- **Manufacturer**: LG
- **Covered Models**: `WT7800CW`
- **Manual Part Number**: MFL68267065
- **Manual Attachment**: Stored in Homebox entity and locally at `images/processed/LG_Washer_Manual.pdf`
...
| Spec | Value |
|---|---|
| **Capacity** | 5.5 cu. ft. (Mega Capacity) |
| **Dimensions** | 27" X 28 3/8" X     44 1/2" (68.6 cm X 72.1 cm X 113 cm) |
